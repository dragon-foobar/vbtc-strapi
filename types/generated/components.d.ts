...
export interface ElementsTeam extends Schema.Component {
...
export interface SectionsHero extends Schema.Component {
  ...
  attributes: {
    ...
    lightModePicture: Attribute.Media & Attribute.Required;
    buttons: Attribute.Component<'links.button-link', true>;
    darkModePicture: Attribute.Media & Attribute.Required;
  };
}
